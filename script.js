		...
		todoElement.innerHTML = `
				...
				<div class="todo__bottom">
					<form class="edit__form">
						<input type="text" name="edit" class="edit__input" />
...
ongoingTodos.addEventListener("click", (e) => {
	...
	if (targetElement.classList.contains("checkbox")) {
		const todoEl = targetElement.parentElement.parentElement.parentElement;
	...
	if (targetElement.classList.contains("delete__btn")) {
		const todo = targetElement.parentElement.parentElement.parentElement;
	...
	if (targetElement.classList.contains("edit__btn")) {
		const todo = targetElement.parentElement.parentElement.parentElement;
		...
		let editForm = editFormBg.querySelector(".edit__form");
...
completedTodos.addEventListener("click", (e) => {
	...
	const todos = Store.getTodoList();
	if (targetElement.classList.contains("checkbox")) {
		const todoElement = targetElement.parentElement.parentElement.parentElement;
